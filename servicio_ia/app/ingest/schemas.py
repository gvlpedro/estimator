"""Pydantic contracts of the ingestion module.

Normalized historical budgets (as found in ``data/budgets_sample.json``) and
the request/response payloads of the ingest endpoint.
"""

from pydantic import BaseModel, Field, model_validator

from app.embedding_pipeline.schemas import Complexity, Sector
