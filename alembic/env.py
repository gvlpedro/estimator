...
# The repo has two "app" packages: the estimator backend (app/) and the AI
# service (servicio_ia/app/). The models live in the latter, so servicio_ia
...
# Metadata of the AI service models (documents, chunks) — enables
